...
Реалізовано InMem репозиторії для товарів і чеків

Реалізовано ProductService, ReceiptService для роботи з товарами та чеками

Реалізовано базове CLI як FSM